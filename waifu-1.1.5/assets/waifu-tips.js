...
// 其他杂项设置
live2d_settings['l2dVersion']           = '1.0.7 (1.4.2)';        // 当前版本
live2d_settings['l2dVerDate']           = '2020.08.19'; // 版本更新日期
live2d_settings['homePageUrl']          = 'https://www.zerolite.cn/';    // 主页地址，桌面版建议设置为auto，可选 'auto'(自动), '{URL 网址}'
